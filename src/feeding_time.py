...
def feeding_time(settings, foodInDay, dayLimit):
	...
	if current_time != "15:31:00":
		...
		sendMessage("It's breakfast time for your dog, would you like to feed your dog? ", foodInDay, dayLimit)
		newday = True
		...
		sendMessage("It's lunch time for your dog, would you like to feed your dog? ", foodInDay, dayLimit)
		newday = False
		newfeedingtime = messageDecoder()
		foodInDay = foodTracker(settings, newfeedingtime, newday, foodInDay, dayLimit)
		...
		dayLimit = dayLimit - foodInDay
		sendMessage("It's dinner time for your dog, would you like to feed your dog? ", foodInDay, dayLimit)
		newday = False
		newfeedingtime = messageDecoder()
		foodInDay = foodTracker(settings, newfeedingtime, newday, foodInDay, dayLimit)
