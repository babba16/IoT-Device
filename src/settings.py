...
def scalerSetting():
	...
	MSG_INFO = client.publish("IC.embedded/BGJR/", "massPrompt")#What mass of food in kg would you like your dog to eat in a day?
	...
	MSG_INFO = client.publish("IC.embedded/BGJR/", ( selectedWeight/3))#"Ok, 1 unit of food is equal to "
	mqtt.error_string(MSG_INFO.rc)
